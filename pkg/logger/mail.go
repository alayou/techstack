...
func (l *MailAdapter) Errorf(logMsg log.Log) {
	...
	Log(LevelError, mailLogSender, format, logMsg.Messages...)
}
...
func (l *MailAdapter) Warnf(logMsg log.Log) {
	...
	Log(LevelWarn, mailLogSender, format, logMsg.Messages...)
}
...
func (l *MailAdapter) Infof(logMsg log.Log) {
	...
	Log(LevelInfo, mailLogSender, format, logMsg.Messages...)
}
...
func (l *MailAdapter) Debugf(logMsg log.Log) {
	...
	Log(LevelDebug, mailLogSender, format, logMsg.Messages...)
}
